				...
				<div class="row">
					<div class="col-12">
						<div class="card m-b-30">
							<div class="card-body">
								<form method="post" action="<?php echo base_url('admin/Service/insert'); ?>" enctype="multipart/form-data">
...
<!--											<input class="form-control" type="text"  id="example-text-input" name="name" required>-->
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input class="form-control" name="date" required type="date" dataformatas="yyyy/mm/dd"  id="example-date-input">
										</div>
									</div>
									<div class="form-group row">
										<label for="example-time-input" class="col-sm-2 col-form-label">From Time</label>
										<div class="col-sm-10">
											<input class="form-control" type="time" name="from_time" required id="example-time-input">
										</div>
									</div>
									<div class="form-group row">
										<label for="example-time-input" class="col-sm-2 col-form-label">To Time</label>
										<div class="col-sm-10">
											<input class="form-control" type="time" name="to_time" required id="example-time-input">
										</div>
									</div>
									<div class="form-group row">
										<label for="example-date-input" class="col-sm-2 col-form-label">Slots</label>
										<div class="col-sm-10">
											<input class="form-control" type="number" min="1" name="slots" required id="example-date-input">
										</div>
									</div>
