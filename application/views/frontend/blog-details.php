...
<head>
    ...
    <!--====== Title ======-->
    <title>Apolz - App Landing Page HTML Template</title>
...
<body>
    ...
    <div class="page-title-area bg_cover" style="background-image: url(<?php echo base_url(); ?>assets/frontend/images/page-bg.png);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-8">
                    <div class="blog-details__main">
                        <div class="blog-details__image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-details-thumb.jpg" alt="thumb">
                        </div><!-- /.blog-details__image -->
                        <div class="blog-details__content">
                            <div class="blog-one__meta">
                                <a href="#"><i class="fa fa-clock-o"></i> 20 Feb</a>
                    ...
                    <div class="blog-author">
                        <div class="blog-author__image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/author.jpg" alt="author">
                    ...
                    <div class="comment-one">
                        ...
                        <div class="comment-one__single">
                            <div class="comment-one__image">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/comment-1-1.jpg" alt="">
                        ...
                        <div class="comment-one__single">
                            <div class="comment-one__image">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/comment-1-2.jpg" alt="">
                            </div><!-- /.comment-one__image -->
                            <div class="comment-one__content">
                                <h3>David Martin</h3>
                                <p class="comment-one__date">20 Mar, 2020 <span>.</span> 4:00 pm</p>
                            ...
                            <div class="sidebar__post-wrap">
                                <div class="sidebar__post__single">
                                    <div class="sidebar__post-image">
                                        <div class="inner-block"><img src="<?php echo base_url(); ?>assets/frontend/images/post-1.png"
                                ...
                                <div class="sidebar__post__single">
                                    <div class="sidebar__post-image">
                                        <div class="inner-block"><img src="<?php echo base_url(); ?>assets/frontend/images/post-2.png"
                                                alt="Awesome Image" /></div>
                                        <!-- /.inner-block -->
                                    </div><!-- /.sidebar__post-image -->
                                    <div class="sidebar__post-content">
                                ...
                                <div class="sidebar__post__single">
                                    <div class="sidebar__post-image">
                                        <div class="inner-block"><img src="<?php echo base_url(); ?>assets/frontend/images/post-3.png"
                                                alt="Awesome Image" /></div>
                                        <!-- /.inner-block -->
                                    </div><!-- /.sidebar__post-image -->
                                    <div class="sidebar__post-content">
