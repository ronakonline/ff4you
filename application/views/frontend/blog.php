        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog-item mt-30">
                        <div class="blog-thumb">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-4.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul>
                                <li><a href="#"><i class="fa fa-clock-o"></i> 20 Feb</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog-item mt-30">
                        <div class="blog-thumb">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-5.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul>
                                <li><a href="#"><i class="fa fa-clock-o"></i> 20 Feb</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog-item mt-30">
                        <div class="blog-thumb">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-6.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul>
                                <li><a href="#"><i class="fa fa-clock-o"></i> 20 Feb</a></li>
