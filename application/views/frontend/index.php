...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/frontend/images/favicon.ico" type="image/png">
...
<body>
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            <div class="side-menu__top justify-content-end">
                ...
                <a href="#" class="side-menu__toggler side-menu__close-btn"><img src="<?php echo base_url(); ?>assets/frontend/images/close.png" alt=""></a>
            </div><!-- /.side-menu__top -->
                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                <a class="navbar-brand" href="index.html"><img src="<?php echo base_url(); ?>assets/frontend/images/logo.png" alt=""></a> <!-- logo -->
                                <a class="navbar-brand-2" href="index.html"><img src="<?php echo base_url(); ?>assets/frontend/images/logo-2.png" alt=""></a> <!-- logo -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7">
                        <div class="banner-content">
                            <h1 class="title">Manage Project With Our Best Application</h1>
                            <p>Nulla facilisi. Proin felis neque, suscipit egestas erat a tincidunt finibus magna consectetur lacus.</p>
                            <a class="main-btn" href="#">Discover More</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-5">
                        <div class="banner-thumb text-right wow fadeInUp" data-wow-duration="1500ms">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/banner-thumb.png" alt="banner">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="section-title text-center">
                        ...
                        <h3 class="title">Apolz Prodiving the Best Features</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="features-btn">
                        <ul class="nav nav-pills d-flex justify-content-between" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active text-center" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">
                                    <i class="flaticon-responsive"><img src="<?php echo base_url(); ?>assets/frontend/images/features-shape.png" alt="shape"></i>
                                    <span>Free Setup</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">
                                    <i class="flaticon-computer-graphic"><img src="<?php echo base_url(); ?>assets/frontend/images/features-shape.png" alt="shape"></i>
                                    <span>Quick Access</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">
                                    <i class="flaticon-seo-and-web"><img src="<?php echo base_url(); ?>assets/frontend/images/features-shape.png" alt="shape"></i>
                                    <span>Manage Users</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">
                                    <i class="flaticon-development"><img src="<?php echo base_url(); ?>assets/frontend/images/features-shape.png" alt="shape"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-5-tab" data-toggle="pill" href="#pills-5" role="tab" aria-controls="pills-5" aria-selected="false">
                                    <i class="flaticon-app-development"><img src="<?php echo base_url(); ?>assets/frontend/images/features-shape.png" alt="shape"></i>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
                                ...
                                <h4 class="title">Free Setup</h4>
                                <p>Lorem Ipsum is simply dummy text of the printing and type setting industry. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts. Lorem Ipsum has been the industry's stan dard dummy text ever since the 1500s.</p>
                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
                                ...
                                <h4 class="title">Fully Secured</h4>
                                <p>Lorem Ipsum is simply dummy text of the printing and type setting industry. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts. Lorem Ipsum has been the industry's stan dard dummy text ever since the 1500s.</p>
                            </div>
    ...
    <section class="about-area pb-100">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumb  wow fadeInLeft" data-wow-duration="1500ms">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/about-thumb.png" alt="">
                        <div class="about-thumb-1">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/about-item-1.png" alt="">
                        </div>
                        <div class="about-thumb-2">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/about-item-2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title">
                            <span>We do more for your world</span>
                            <h3 class="title">Interact with Customers on Single Application</h3>
                        </div>
                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum lorem ipsum is simply free text dolore eu fugiat nulla pariatur.</p>
                        <ul>
                            ...
                            <li><i class="fa fa-check-circle"></i> Lorem ipsum is simply free text.</li>
                        </ul>
        ...
        <div class="about-shape-2">
            <img src="<?php echo base_url(); ?>assets/frontend/images/about-shape.png" alt="shape">
        </div>
    </section>
            ...
            <div class="row brand-active">
                <div class="col-lg-3">
                    <div class="brand-item">
                        <a href="#"><img src="<?php echo base_url(); ?>assets/frontend/images/brand.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="brand-item">
    ...
    <section class="business-area pt-110 pb-120">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="business-content">
                        <div class="section-title">
                            <span>We do more for your world</span>
                            <h3 class="title">Powerful Mobile Application For Your Business</h3>
                        </div>
                        <div class="row mr-110">
                            <div class="col-sm-4">
                                <div class="business-item">
                                    <i class="flaticon-business"></i><br>
                                    <span>Our Business <br> Strategy</span>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and type setting industry. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts. Lorem Ipsum has been the dummy text ever since the 1500s.</p>
                        <a class="main-btn" href="#">Discover More</a>
                    </div>
                </div>
            </div>
        ...
        <div class="business-thumb text-right">
            <img src="<?php echo base_url(); ?>assets/frontend/images/business-thumb.jpg" alt="">
        </div>
    ...
    <section class="customers-area pt-120 pb-120">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="customers-thumb wow fadeInLeft" data-wow-duration="1500ms">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/customers-thumb.png" alt="customers">
                    </div>
                </div>
        ...
        <div class="customers-shape text-right">
            <img src="<?php echo base_url(); ?>assets/frontend/images/customers-shape.png" alt="shape">
        </div>
    ...
    <div class="video-play-area bg_cover" style="background-image: url(<?php echo base_url(); ?>assets/frontend/images/video-play-bg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-play-item text-center">
                        <a class="video-popup" href="https://www.youtube.com/watch?v=Qm2nxiLUhvM"><i class="fa fa-play"></i></a>
                        <p>2 Minutes demo of our application</p>
                        <h4 class="title">Watch Our Video Presentation</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="testimonials" class="testimonials-area bg_cover pt-120 pb-120" style="background-image: url(<?php echo base_url(); ?>assets/frontend/images/testimonials-bg.jpg);">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-9">
                    <div class="testimonials-user-item">
                        <div class="testimonials-thumb pl-110">
                            <div class="item">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials-user-1.png" alt="">
                            </div>
                            <div class="item">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials-user-2.png" alt="">
                            </div>
                            <div class="item">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials-user-3.png" alt="">
                            </div>
                        </div>
                        <div class="testimonials-user">
                            <div class="item-1">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials/user-1.png" alt="testimonials">
                            </div>
                            <div class="item-2">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials/user-2.png" alt="testimonials">
                            </div>
                            <div class="item-3">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials/user-3.png" alt="testimonials">
                            </div>
                            <div class="item-4">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials/user-4.png" alt="testimonials">
                            </div>
                            <div class="item-5">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials/user-5.png" alt="testimonials">
                            </div>
                            <div class="item-6">
                                <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials/user-6.png" alt="testimonials">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="testimonials-shape">
            <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials-shape.png" alt="">
        </div>
        <div class="testimonials-map">
            <img src="<?php echo base_url(); ?>assets/frontend/images/testimonials-map.png" alt="">
        </div>
            ...
            <div class="row screenshot-active">
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/screenshot-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/screenshot-2.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/screenshot-3.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/screenshot-4.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="<?php echo base_url(); ?>assets/frontend/images/screenshot-5.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="faq-content">
                        ...
                        <img src="<?php echo base_url(); ?>assets/frontend/images/faq-thumb.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="blog-item mt-30">
                        <div class="blog-thumb">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-1.jpg" alt="blog">
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="blog-item mt-30">
                        <div class="blog-thumb">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-2.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul>
                                <li><a href="#"><i class="fa fa-clock-o"></i> 20 Feb</a></li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="blog-item mt-30">
                        <div class="blog-thumb">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/blog-3.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul>
                                <li><a href="#"><i class="fa fa-clock-o"></i> 20 Feb</a></li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="footer-widget footer-widget-about">
                        <a href="#"><img src="<?php echo base_url(); ?>assets/frontend/images/logo.png" alt="logo"></a>
    ...
    <!--====== jquery js ======-->
    <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/modernizr-3.6.0.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/jquery-3.5.0.js"></script>
